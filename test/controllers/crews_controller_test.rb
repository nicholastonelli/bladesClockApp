...
class CrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crew" do
    assert_difference("Crew.count") do
      post crews_url, params: { crew: { description: @crew.description, hold: @crew.hold, name: @crew.name, rep: @crew.rep, reputation: @crew.reputation, tier: @crew.tier, type: @crew.type } }
    end
  ...
  test "should update crew" do
    patch crew_url(@crew), params: { crew: { description: @crew.description, hold: @crew.hold, name: @crew.name, rep: @crew.rep, reputation: @crew.reputation, tier: @crew.tier, type: @crew.type } }
