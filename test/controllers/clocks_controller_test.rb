...
class ClocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clock" do
    assert_difference("Clock.count") do
      post clocks_url, params: { clock: { description: @clock.description, marked: @clock.marked, name: @clock.name, sections: @clock.sections } }
    end
  ...
  test "should update clock" do
    patch clock_url(@clock), params: { clock: { description: @clock.description, marked: @clock.marked, name: @clock.name, sections: @clock.sections } }
