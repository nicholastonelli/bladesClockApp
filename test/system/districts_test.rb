...
class DistrictsTest < ApplicationSystemTestCase
  ...
  test "should create district" do
    ...
    fill_in "Buildings", with: @district.buildings
    fill_in "Crime", with: @district.crime
    fill_in "Description", with: @district.description
    fill_in "Name", with: @district.name
    fill_in "Occult", with: @district.occult
    fill_in "Scene", with: @district.scene
    fill_in "Security", with: @district.security
    fill_in "Special", with: @district.special
    fill_in "Streets", with: @district.streets
    fill_in "Wealth", with: @district.wealth
